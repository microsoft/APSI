...
namespace apsi {
    namespace receiver {
        ...
        nullptr if the received response was not of the correct type. A PSIParams object can be
        ...
        not of the correct type. Finally, Receiver::ExtractHashes must be called with the
        ...
        the received response was not of the correct type. The QueryResponse contains only one
