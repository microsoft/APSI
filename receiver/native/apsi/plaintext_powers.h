...
namespace apsi
{
    namespace receiver
    {
        ...
        public:
            ...
            std::unordered_map<std::uint32_t, SEALObject<seal::Ciphertext>> encrypt(const CryptoContext &crypto_context);
        ...
        private:
            ...
            void multiply_array(gsl::span<std::uint64_t> in1, gsl::span<std::uint64_t> in2, gsl::span<std::uint64_t> out) const;
