...
namespace apsi
{
	...
	public:
		...
		inline int sender_thread_count() const
		{
			return sender_thread_count_;
		}

		void set_sender_thread_count(int sender_thread_count)
		{
			sender_thread_count_ = sender_thread_count;
		}
