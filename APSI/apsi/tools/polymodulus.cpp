...
#endif
        coeff_count_power_of_two_ = seal::util::get_power_of_two(static_cast<uint64_t>(coeff_count - 1));
        is_one_zero_one_ = seal::util::is_one_zero_one_poly(poly, coeff_count, coeff_uint64_count);
    }
