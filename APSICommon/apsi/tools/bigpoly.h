...
namespace apsi
{
    ...
    */
    ...
    public:
        ...
        */
        inline std::size_t significant_coeff_count() const
        {
            ...
            return seal::util::get_significant_coeff_count_poly(
        ...
        */
        inline bool is_zero() const
        {
            ...
            return seal::util::is_zero_poly(value_.get(), coeff_count_, coeff_uint64_count_);
        }
        ...
        */
        inline const seal::BigUInt &operator [](std::size_t coeff_index) const
        {
            if (coeff_index >= coeff_count_)
            {
        ...
        @see BigUInt for operations that can be performed on the coefficients.
        */
        inline seal::BigUInt &operator [](std::size_t coeff_index)
        {
            if (coeff_index >= coeff_count_)
            {
                throw std::out_of_range("coeff_index must be within [0, coefficient count)");
        ...
        */
        ...
        {
            seal::util::set_zero_poly(coeff_count_, coeff_uint64_count_, value_.get());
        }
        ...
        */
        inline void set_zero(std::size_t start_coeff, std::size_t length)
        {
            ...
            {
                std::uint64_t *coeff = seal::util::get_poly_coeff(
                    value_.get(), start_coeff, coeff_uint64_count_);
                seal::util::set_zero_poly(length, coeff_uint64_count_, coeff);
            }
        }
    ...
    private:
        ...
        */
        seal::util::Pointer<std::uint64_t> value_;
        ...
        count is zero.
        */
        std::vector<seal::BigUInt> coeffs_;
