...
namespace apsi {
    namespace sender {
        ...
        not of the correct type. Once the request has been obtained, the RunParams function can be
        ...
        This function will return nullptr if the received request was not of the correct type. Once
