        ...
        public:
            ...
            */
            ...
            virtual void send_preprocess_response(
                const std::vector<seal::SEAL_BYTE> &client_id, const std::vector<seal::SEAL_BYTE> &buffer) = 0;
            ...
            */
            virtual void send_query_response(
                const std::vector<seal::SEAL_BYTE> &client_id, const size_t package_count) = 0;
