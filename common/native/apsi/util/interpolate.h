...
namespace apsi
{
    namespace util
    {
        ...
        */
        void polyn_mul_monic_monomial_inplace(std::vector<std::uint64_t> &polyn, std::uint64_t a, const seal::Modulus &mod);
        ...
        */
        std::vector<std::uint64_t> polyn_with_roots(std::vector<std::uint64_t> &roots, const seal::Modulus &mod);
    }
} // namespace apsi
