...
namespace APSITests
{
    TEST(CSVReaderTests, read_test)
    {
        ...
        ASSERT_EQ((Byte)2, labels[0][0]);
        ASSERT_EQ((Byte)0, labels[0][1]);
        ASSERT_EQ((Byte)0, labels[0][2]);
        ASSERT_EQ((Byte)0, labels[0][3]);
        ASSERT_EQ((Byte)0, labels[0][4]);
        ASSERT_EQ((Byte)0, labels[0][5]);
        ASSERT_EQ((Byte)0, labels[0][6]);
        ASSERT_EQ((Byte)0, labels[0][7]);

        ASSERT_EQ((Byte)4, labels[1][0]);
        ASSERT_EQ((Byte)0, labels[1][1]);
        ASSERT_EQ((Byte)0, labels[1][2]);
        ASSERT_EQ((Byte)0, labels[1][3]);
        ASSERT_EQ((Byte)0, labels[1][4]);
        ASSERT_EQ((Byte)0, labels[1][5]);
        ASSERT_EQ((Byte)0, labels[1][6]);
        ASSERT_EQ((Byte)0, labels[1][7]);

        ASSERT_EQ((Byte)6, labels[2][0]);
        ASSERT_EQ((Byte)0, labels[2][1]);
        ASSERT_EQ((Byte)0, labels[2][2]);
        ASSERT_EQ((Byte)0, labels[2][3]);
        ASSERT_EQ((Byte)0, labels[2][4]);
        ASSERT_EQ((Byte)0, labels[2][5]);
        ASSERT_EQ((Byte)0, labels[2][6]);
        ASSERT_EQ((Byte)0, labels[2][7]);

        ASSERT_EQ((Byte)8, labels[3][0]);
        ASSERT_EQ((Byte)0, labels[3][1]);
        ASSERT_EQ((Byte)0, labels[3][2]);
        ASSERT_EQ((Byte)0, labels[3][3]);
        ASSERT_EQ((Byte)0, labels[3][4]);
        ASSERT_EQ((Byte)0, labels[3][5]);
        ASSERT_EQ((Byte)0, labels[3][6]);
        ASSERT_EQ((Byte)0, labels[3][7]);
    }
    ...
    TEST(CSVReaderTests, read_extra_info_test)
    {
        ...
        ASSERT_EQ((Byte)2, labels[0][0]);
        ASSERT_EQ((Byte)7, labels[1][0]);
        ASSERT_EQ((Byte)12, labels[2][0]);
    ...
    TEST(CSVReaderTests, read_missing_info_test)
    {
        ...
        ASSERT_EQ((Byte)2, labels[0][0]);
        ASSERT_EQ((Byte)4, labels[1][0]);
        ASSERT_EQ((Byte)0, labels[2][0]);
        ASSERT_EQ((Byte)7, labels[3][0]);
        ASSERT_EQ((Byte)9, labels[4][0]);
        ASSERT_EQ((Byte)0, labels[5][0]);
        ASSERT_EQ((Byte)12, labels[6][0]);
        ASSERT_EQ((Byte)0, labels[7][0]);
    ...
    TEST(CSVReaderTests, read_max_bits_test)
    {
        ...
        ASSERT_EQ((Byte)0xFE, labels[0][0]);
        ASSERT_EQ((Byte)0xFF, labels[0][1]);
        ASSERT_EQ((Byte)0xFF, labels[0][2]);
        ASSERT_EQ((Byte)0xFF, labels[0][3]);
        ASSERT_EQ((Byte)0xFF, labels[0][4]);
        ASSERT_EQ((Byte)0xFF, labels[0][5]);
        ASSERT_EQ((Byte)0xFF, labels[0][6]);
        ASSERT_EQ((Byte)0x05, labels[0][7]);
        ...
        for (size_t r = 0; r < labels.rows(); r++)
        {
            ...
            {
                ASSERT_EQ((Byte)0xFF, labels[r][c]);
            }
        }
    }
    ...
    TEST(CSVReaderTests, read_hex_values_test)
    {
        ...
        ASSERT_EQ((Byte)0xEF, labels[0][0]);
        ASSERT_EQ((Byte)0xBE, labels[0][1]);
        ASSERT_EQ((Byte)0xAD, labels[0][2]);
        ASSERT_EQ((Byte)0xDE, labels[0][3]);
        ASSERT_EQ((Byte)0xEF, labels[0][0]);
        ASSERT_EQ((Byte)0x15, labels[1][0]);
        ASSERT_EQ((Byte)0x03, labels[1][1]);
        ASSERT_EQ((Byte)0x21, labels[2][0]);
        ASSERT_EQ((Byte)0xa3, labels[2][1]);
        ASSERT_EQ((Byte)0xcb, labels[2][2]);
        ASSERT_EQ((Byte)0xfd, labels[2][3]);
    }
